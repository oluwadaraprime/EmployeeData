...
pool.query(
    `INSERT INTO TeamOkunade2021 
                (ID, USERNAME, EMAIL, DEPARTMENT, ROLE, SHIFT, WAGES)
                 VALUES 
                 ('1', 'oluwadaraprime', 'oluwadaraokunade@gmail.com', 'Management', 'Manager', '01-21-2021', '30.99'),
                 ('2', 'sonnyJay', 'johnson@gmail.com', 'Science', 'Teacher', '01-21-2021', '25.00'),
                 ('3', 'adeboy', 'adeolu@gmail.com', 'Management', 'Security', '01-21-2021', '23.50'),
                 ('4', 'segundola', 'segun12@gmail.com', 'Arts', 'Teacher', '01-22-2021', '22.00'),
                 ('5', 'olustar', 'olaoluwa@gmail.com', 'Management', 'Accountant', '01-21-2021', '27.50'),
                 ('6', 'trixsta', 'tisha@gmail.com', 'Social Sciences', 'Teacher', '01-25-2021', '25.00')              
                 `,
    (err, res) => {
      if(err) {
